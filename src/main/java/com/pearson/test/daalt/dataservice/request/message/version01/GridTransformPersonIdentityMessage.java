...
public class GridTransformPersonIdentityMessage extends SubPubMessage {
	//grid.daalt.transform.identityprofile.created
	
	public GridTransformPersonIdentityMessage() {
		payload = new GridTransformPersonIdentityMsgPayload();
	}

	@Override
	public void setProperty(String propertyName, Object propertyValue) throws UnknownPropertyException {
		GridTransformPersonIdentityMsgPayload specificPayload = (GridTransformPersonIdentityMsgPayload) payload;
		switch(propertyName) {
			case "Person" :
	...
	public class GridTransformPersonIdentityMsgPayload extends MessagePayload {
