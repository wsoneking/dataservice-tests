...
public class UserUnloadsNonBookContentWithAssignmentTinCanMessage extends SeerMessage {

	public UserUnloadsNonBookContentWithAssignmentTinCanMessage(){
	...
	public class CompleteTincanMessageSource extends MessageSource {
		//required : hard code
		public String Message_Type_Code = "User_Unloads_Non_Book_Content_With_Assignment";
		//required : hard code
...
//		}
		...
		public class Context {
			...
			public class Extension {
				...
				public String Page_Id = "performance.assignment"; 
				//required: hard-code;our model needs changes to set values for setting LR that are not assignments and should not be viewed in the context of LR
