...
public class MultiValueBinningQuestion extends MultiValueQuestion {

	private List<SubQuestion> subQuestions;
	private boolean isPractice;
	
	public MultiValueBinningQuestion() {
		String randomUUID = UUID.randomUUID().toString();
		this.id = "SQE-" + QuestionPresentationFormat.BINNING.value + "-" + randomUUID;
		isSeeded = true;
		isPractice = false;
		seedDateTime = getCurrentTimeFormatted();
	}
	
	public MultiValueBinningQuestion(String text, float pointsPossible, float sequenceNumber) {
		this();
		this.text = text;
	...
	public Question copyMe() {
		Question copy = new MultiValueBinningQuestion();
	...
	public String getQuestionPresentationFormat() {
		return QuestionPresentationFormat.BINNING.value;
	}
	
	@Override
	public QuestionPresentationFormat getQuestionPresentationFormatAsEnum() {
		return QuestionPresentationFormat.BINNING;
	}
