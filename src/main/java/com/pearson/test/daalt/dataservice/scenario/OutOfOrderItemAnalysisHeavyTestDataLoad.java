...
/**
 * Reverse all the message sending.
 ...
 */
public class OutOfOrderItemAnalysisHeavyTestDataLoad extends BaseTestScenario {
	private AssignmentFactory assignmentFactory;

	@Test
	public void loadBasicTestData() throws Exception {
		TestDataRequest first1Request;
		TestDataRequest first2Request;
		TestDataRequest first3Request;
		...
		try {
			first1Request = new BasicTestDataRequest();
			first2Request = new BasicTestDataRequest();
			first3Request = new BasicTestDataRequest();
			...
			first1Request.addTestAction(createCourseSection);
			...
			first2Request.addTestAction(enrollInstr);
			...
			first2Request.addTestAction(enrollStudent);	
			...
			first3Request.addTestAction(addAssignment);
			...
			first3Request.executeAllActions();
			first2Request.executeAllActions();
			first1Request.executeAllActions();
