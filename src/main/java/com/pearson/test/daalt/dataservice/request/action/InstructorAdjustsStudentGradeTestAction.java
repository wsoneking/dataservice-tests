...
public abstract class InstructorAdjustsStudentGradeTestAction implements TestAction{
	...
	public void checkCriticalObjects() throws InvalidStateException {
		...
		if (courseSection == null) {
			throw new InvalidStateException("Failed to execute AssessmentPerformanceTestAction - "
