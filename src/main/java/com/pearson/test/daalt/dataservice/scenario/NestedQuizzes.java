...
import com.pearson.test.daalt.dataservice.validation.Validation;
		 ...
		 *   chapter
                Quiz
                	Quiz
                	Quiz
             Nested quizzes. Enroll one student. 
		 */
		
public class NestedQuizzes extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			for(Question ques : nestedQuiz1.getQuestions()){
				...
				QuestionCompletionActivity questionCompletionActivity = new QuestionCompletionActivity(student1, ques.getPointsPossible());
				ques.addCompletionActivity(questionCompletionActivity);
				TestAction attemptQuestionTestAction = testActionFactory.getAttemptQuestionTestAction(courseSection, assignmentToAdd, nestedQuiz1, ques, attempt, questionCompletionActivity);
			...
			TestAction nestedQuiz1TestAction = testActionFactory.getCompleteQuizTestAction(courseSection, assignmentToAdd, nestedQuiz1, nestedQuiz1CompletionActivity);
			...
			for(Question ques : nestedQuiz2.getQuestions()){
				...
				QuestionCompletionActivity questionCompletionActivity = new QuestionCompletionActivity(student1, ques.getPointsPossible());
				ques.addCompletionActivity(questionCompletionActivity);
				TestAction attemptQuestionTestAction = testActionFactory.getAttemptQuestionTestAction(courseSection, assignmentToAdd, nestedQuiz2, ques, attempt, questionCompletionActivity);
			...
			TestAction nestedQuiz2TestAction = testActionFactory.getCompleteQuizTestAction(courseSection, assignmentToAdd, nestedQuiz2, nestedQuiz2CompletionActivity);
