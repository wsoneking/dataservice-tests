...
public class SubPubSeerAttemptMultiValueQuestionAsPracticeTestAction extends AttemptMultiValueQuestionAsPracticeTestAction {
	
	public SubPubSeerAttemptMultiValueQuestionAsPracticeTestAction(CourseSection courseSection,
	...
	public void execute(int seerCount, int subPubCount) throws Exception {
		...
		System.out.println("Now executing AttemptMultiValueQuestionAsPracticeTestAction...\n");
		...
		message.setProperty("PracticeFlag", "Practice");
