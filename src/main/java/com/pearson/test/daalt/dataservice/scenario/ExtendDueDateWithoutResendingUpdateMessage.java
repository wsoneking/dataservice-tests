 ...
 * 
 */
public class ExtendDueDateWithoutResendingUpdateMessage extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			testData = new BasicTestData("ExtendDueDateWithoutResendingUpdateMessage");
			...
			TestAction passDueDateTestAction1 = testActionFactory.getSimulateDueDatePassingTestAction(instr, courseSection, assignmentToAdd);
			fourthRequest.addTestAction(passDueDateTestAction1);
