...
import com.pearson.test.daalt.dataservice.request.message.TOTUserUnloadsQuestionTincanMessage.TOTUserUnloadsQuestionTincanMessageSource;
/**
 *
 */

public class TOTUserUnloadsQuestionTincanMessageValidityTest extends BaseTestSingleMessage {
...
*/
	...
	public String getMessage(String uuid) throws JsonGenerationException, JsonMappingException, IOException {
		...
		TOTUserUnloadsQuestionTincanMessage msg = new TOTUserUnloadsQuestionTincanMessage(/*isAttempt*/ true);
		TOTUserUnloadsQuestionTincanMessageSource msgSource = (TOTUserUnloadsQuestionTincanMessageSource) msg.messageSource;
		msgSource.context.extensions = msgSource.context.new AttemptExtension();
		
		msgSource.actor.account.Person_Source_System_Record_Id = "" + UUID.randomUUID().toString();
		msgSource.verb.id = "http://adlnet.gov/expapi/verbs/answered";
		msgSource.verb.display.verb = "answered";
		msgSource.context.extensions.User_Activity_Causing_Unload = "User_Answers_Question";
		...
		msgSource.context.extensions.Duration_In_Seconds = 60;		
