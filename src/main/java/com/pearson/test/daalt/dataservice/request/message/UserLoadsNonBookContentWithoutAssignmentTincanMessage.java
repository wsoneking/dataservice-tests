...
public class UserLoadsNonBookContentWithoutAssignmentTincanMessage extends SeerMessage {
	
	public UserLoadsNonBookContentWithoutAssignmentTincanMessage(){
	...
	public class CompleteTincanMessageSource extends MessageSource {
		//required : hard code
		public String Message_Type_Code = "User_Loads_Non_Book_Content_Without_Assignment";
		//required : hard code
		...
		public class Context {
			...
			public class Extension {
				...
				public String Page_Id = "course-notes"; 
				...
				public String Ref_Page_Group_Code = "course";
				//required: hard-code;our model needs changes to set values for setting LR that are not assignments but needs to view in the context of LR
				public String Ref_Page_Content_Code ="notes";
