...
public class WritingSpaceSameAssignment extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			testData = new BasicTestData("WritingSpaceSameAssignment");
			...
			int timeSpent = 60;
			QuestionCompletionActivity chap1QuizQuestionCompletionActivity = new QuestionCompletionActivity(student, /*score*/ 0f);
			...
			chap1QuizCompletionActivity.addQuestionPerf(chap1QuizQues.getId(), /*pointsEarned*/ 0f);
			...
			thirdRequest.addTestAction(chap2WritingSpaceCompleteQuizTestAction);
