 ...
 *  course section contains two assignments, 
    ...
    by sending Learning_Module and Learning_Module_Content messages with Transaction_Type_Code = "Update"
    
    DOES NOT WORK - NOT EXPECTED TO WORK
 */
public class MoveAssignmentContentViaUpdate extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			TestAction updateAssignment1Content = testActionFactory.getUpdateAssignmentContentTestAction(instr, courseSection, assignmentToAdd1);
			fifthRequest.addTestAction(updateAssignment1Content);
			TestAction updateAssignment2Content = testActionFactory.getUpdateAssignmentContentTestAction(instr, courseSection, assignmentToAdd2);
			fifthRequest.addTestAction(updateAssignment2Content);
