...
/*
 * Student Leaves Chapter Quiz Question 1
 * Student completes Chapter Quiz
 */
public class StudentLeavesQuestionAndCompletesQuiz extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			testData = new BasicTestData("StudentLeavesQuestionAndCompletesQuiz");
			...
			//Student 1 - Leaves Chapter Quiz Question 1
			int timeSpent = 40;
			MultipleChoiceLeaveQuestion leaveQues1 = new MultipleChoiceLeaveQuestion();
			leaveQues1.setUser(student);
			leaveQues1.setTimeSpent(timeSpent);
			chapQuizQues1.addLeaveQuestion(leaveQues1);
			TestAction stud1Leave1ChapQuizQuestion1TestAction = testActionFactory.getLeaveQuestionTestAction(student, courseSection, chapQuiz, chapQuizQues1, leaveQues1, null);
			secondRequest.addTestAction(stud1Leave1ChapQuizQuestion1TestAction);
			...
			thirdRequest.addTestAction(stud1CompleteChapQuizTestAction);
