 ...
 */
public class ItemAnalysisHeavyTestDataLoad extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			String testVar = getEngine().getTestVar();
			System.out.println("Value found by scenario: " + testVar);
