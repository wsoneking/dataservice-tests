...
public abstract class UserLoadNonBookContentWithAssignmentTestAction implements TestAction {
	...
	public void checkCriticalObjects() throws InvalidStateException {
		if (courseSection == null) {
			throw new InvalidStateException("Failed to execute UserLoadNonBookContentWithAssignmentTestAction - "
		...
		if (lastActivityDate == null) {
			throw new InvalidStateException("Failed to execute UserLoadNonBookContentWithAssignmentTestActionn - "
					+ "lastActivity not specified");
		}
}
}