...
public class MultiValueHotSpotQuestion extends MultiValueQuestion {

	private SubQuestion subQuestion;
	private boolean isPractice;
	
	public MultiValueHotSpotQuestion() {
		String randomUUID = UUID.randomUUID().toString();
		this.id = "SQE-" + QuestionPresentationFormat.HOT_SPOT.value + "-" + randomUUID;
		isSeeded = true;
		isPractice = false;
		seedDateTime = getCurrentTimeFormatted();
	}
	
	public MultiValueHotSpotQuestion(String text, float pointsPossible, float sequenceNumber) {
		this();
		this.text = text;
	...
	public Question copyMe() {
		Question copy = new MultiValueHotSpotQuestion();
	...
	public String getQuestionPresentationFormat() {
		return QuestionPresentationFormat.HOT_SPOT.value;
	}
	
	@Override
	public QuestionPresentationFormat getQuestionPresentationFormatAsEnum() {
		return QuestionPresentationFormat.HOT_SPOT;
	}
