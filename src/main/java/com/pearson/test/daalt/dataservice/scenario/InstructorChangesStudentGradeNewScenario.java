 ...
 * Send second Assessmen_Item_Completion and AssessmentPerformanceMessage message
 */

public class InstructorChangesStudentGradeNewScenario extends BaseTestScenario {
	...
	public void loadBasicTestData() throws Exception {
		...
		try {
			...
			testData = new BasicTestData("InstructorChangesStudentGradeNewScenario");
			...
			for(Question ques : chapQuiz.getQuestions()){
				...
				//Question completion activity
				QuestionCompletionActivity questionCompletionActivity = new QuestionCompletionActivity(student, 1f);
				ques.addCompletionActivity(questionCompletionActivity);
			...
			TestAction updateScoreTestAction = testActionFactory.getUpdateScoreTestAction(courseSection, assignmentToAdd, chapQuiz, chapQuizCompletionActivity2 );
			thirdRequest.addTestAction(updateScoreTestAction);
